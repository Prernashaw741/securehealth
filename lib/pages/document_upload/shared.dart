  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (controller) =>  Obx(() => Scaffold(
        appBar: AppBar(
          title:  Text("Shared Documents",style: GoogleFonts.inter(
            fontSize: 15,
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: PopupMenuButton(
                  ...
                  itemBuilder: (context) {
                    return [
                      ...
                      //                   await controller
                      //                       .delete_document(
                      //                           controller.sharedByYou[index].id)
                      //                       .then((value) => value
                      ...
                      //                       // await Share.share(
                      //                       //     'check out my document from SecureHealth ${controller.sharedByYou[index].document}');
                      //                       Navigator.pop(context);
                      //                       controller.get_documents();
                      //                       controller.counts();
                      //                     },
                ...
                title: Text("${controller.sharedByYou[index].documentName}"),
